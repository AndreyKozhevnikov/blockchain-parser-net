...
namespace BlockParser.Classes {
    ...
    public class ScriptParser {
      ...
      public  string? ExtractDestination(byte[] data) {
            //byte[] solutions;
            ...
            //         publicKeyHash = new KeyId(solutions);
            //        address = publicKeyHash.GetAddress(Network.Main).ToString() ;
            //        break;
            //    case "TxoutType::WITNESS_V0_SCRIPTHASH":
            //        //var test = new Key(solutions);
            //        //address = test.GetAddress(scr.Segwit, Network.Main).ToString();
            //        break;
            //}
            //return address;
        }
